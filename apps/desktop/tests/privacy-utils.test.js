...
const sensitiveText = [
  "2026-06-12 21:08 许念 他的手机号是 13812345678，邮箱 linche@example.com。",
  "身份证 11010519900307891X，微信号 wxLinche88，QQ: 123456789。",
  "住址: 上海市浦东新区世纪大道88号，单位: 星河科技有限公司。",
  "林澈 说她只是普通朋友，你别多想。"
].join("\n");
...
const noNameMask = privacy.redactText("林澈 手机号 13812345678", {
  maskNames: false,
  importMeta: { participants: [{ name: "林澈", count: 1 }] }
});
assert.equal(noNameMask.text.includes("林澈"), true);
assert.equal(noNameMask.text.includes("13812345678"), false);
...
const structured = privacy.redactText("2026-06-12 21:08:17 许念 你今天又不回消息。\n2026-06-12 21:09:02 林澈 别多想。", {
  senderSource: "2026-06-12 21:08:17 许念 你今天又不回消息。\n2026-06-12 21:09:02 林澈 别多想。"
});
assert.equal(structured.text.includes("许念"), false);
assert.equal(structured.text.includes("林澈"), false);
assert.ok(privacy.extractStructuredAliases("2026-06-12 21:08:17 许念 你今天又不回消息。").includes("许念"));
